...
const CompletePortfolioApp = () => {
  ...
  // Register User - FIXED: Better error handling
  const handleRegister = async (e) => {
    ...
    if (passwordStrength.score < 5) {
      setAuthMessage({ type: 'error', text: 'Password does not meet requirements' });
      return;
    }
            ...
            {authView === 'login' ? (
              ...
              <form onSubmit={handleRegister} className="space-y-4">
                ...
                <div>
                  ...
                  />
                  {registerForm.username && !/^[a-zA-Z0-9_]+$/.test(registerForm.username) && (
  ...
  // DASHBOARD VIEW (Portfolio management - same as before)
  return (
